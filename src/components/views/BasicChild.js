...
var BasicChild = function (_React$Component) {
    ...
    _createClass(BasicChild, [{
        ...
        value: function render() {
            ...
            return React.createElement("section", null, React.createElement("h1", null, "Child"), React.createElement("section", null, React.createElement("h1", null, "From Parent"), React.createElement("p", null, React.createElement(MessageArea_1.default, { "message": parentMessageProps }))), React.createElement("section", null, React.createElement("h1", null, "From Url Params"), React.createElement("p", null, React.createElement(MessageArea_1.default, { "message": idProps }))), React.createElement("section", null, React.createElement("h1", null, "Child State"), React.createElement("div", { "className": "input-form" }, React.createElement("h1", null, "Message"), React.createElement("p", null, React.createElement("input", { "type": "text", "ref": "message" }), React.createElement("input", { "type": "button", "value": "Change", "onClick": this.handleChangeClick })), React.createElement("p", null, React.createElement(MessageArea_1.default, { "message": messageProps })))));
        }
    }]);
